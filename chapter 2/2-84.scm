...
(add (make-scheme-number 2) (make-scheme-number 2))
(add (make-scheme-number 2) (make-rational 1 3))
(add (make-real 2.5) (make-rational 1 3))
(add (make-from-real-imag 2 3) (make-rational 1 3))
(add (make-from-real-imag 2 3) (make-scheme-number 9))
